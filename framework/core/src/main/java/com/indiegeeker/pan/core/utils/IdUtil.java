package com.indiegeeker.pan.core.utils;
...
public class IdUtil {
    ...
    public static Long decrypt(String decryptId) {
        ...
        throw new BusinessException("the decryptId can not be empty");
    }
    ...
    public static List<Long> decryptIdList(String decryptIdStr) {
        ...
        List<String> decryptIdList = Splitter.on(Constants.COMMON_SEPARATOR).splitToList(decryptIdStr);
